...
export const MELBET_LOGO_SIZES = ["xs", "nav", "sm", "md", "lg", "hero"] as const;
export const MELBET_LOGO_VARIANTS = [
  "idle",
  "scan",
  "wave",
  "slot",
...
export type MelbetLogoVariant = (typeof MELBET_LOGO_VARIANTS)[number];
...
export const MELBET_LOGO_DEFAULTS = {
  glow: true,
  size: "md",
  variant: "idle",
} as const;

export const MELBET_LOGO_ASSET_PATH = "/logo.svg";
export const MELBET_LOGO_VIEWBOX = "0 0 533 94";

export const MELBET_LOGO_WIDTHS = {
  xs: "76px",
  nav: "84px",
  sm: "150px",
  md: "190px",
  lg: "240px",
  hero: "clamp(180px, 38vw, 360px)",
} as const;

export const MELBET_LOGO_FRAME_WIDTHS = {
  xs: "92px",
  nav: "102px",
  sm: "172px",
  md: "214px",
  lg: "268px",
  hero: "calc(clamp(180px, 38vw, 360px) + 36px)",
} as const;

const framePaddingXMap = {
  xs: "8px",
  nav: "10px",
  sm: "11px",
  md: "12px",
...
export function MelbetAnimatedLogo({
  ...
  className,
  decorative = false,
  glow = MELBET_LOGO_DEFAULTS.glow,
  size = MELBET_LOGO_DEFAULTS.size,
  variant = MELBET_LOGO_DEFAULTS.variant,
  ...
  return (
    <span
      className={joinClasses(
        "melbet-logo",
        `melbet-logo--${variant}`,
        glow && "melbet-logo--glow",
        className,
      )}
      style={
        {
          ["--melbet-width" as string]: MELBET_LOGO_WIDTHS[size],
          ["--melbet-frame-width" as string]: MELBET_LOGO_FRAME_WIDTHS[size],
          ["--melbet-frame-pad-x" as string]: framePaddingXMap[size],
          ["--melbet-frame-pad-y" as string]: framePaddingYMap[size],
        } as CSSProperties
      }
    >
      <span aria-hidden="true" className="melbet-logo__shine" />
      ...
      >
        {letters.map((letter, index) => (
          <g
            ...
            style={
              {
                ["--melbet-letter-delay" as string]: `${index * 90}ms`,

...
export default function PartnerHero() {
  ...
  return (
    <section className="relative overflow-hidden px-6 pb-0 pt-[86px] md:px-20">
      <div className="mx-auto max-w-[1520px]">
        <div className="relative min-h-[730px]">
          ...
          <div className="relative z-20 grid min-h-[500px] grid-cols-[1.05fr_0.95fr_0.65fr] items-start">
            <div className="pt-[74px]">
              <div
                dir={isRTL ? "rtl" : "ltr"}
                className={isRTL ? "text-right" : "text-left"}
              >
                <div className="max-w-[700px] text-[84px] font-medium leading-[0.88] tracking-[-0.07em] text-[var(--color-fg)]">
              ...
              <div className="mt-2 flex items-center">
                <button
                  dir={isRTL ? "rtl" : "ltr"}
                  className={[
                    "flex h-[48px] items-center rounded-full bg-[var(--color-primary-soft)] text-[22px] font-medium tracking-[-0.04em] text-[var(--color-primary)]",
            ...
            <div className="relative flex h-[690px] items-start justify-end">
              ...
              <div className="relative z-30 mt-[16px] mr-[164px] rotate-[28deg]">
                <PhoneMockup>
                  <PhoneData />
                </PhoneMockup>
              </div>
            ...
            <div className="pt-[124px]">
              ...
              <div className="mt-[68px] flex items-center gap-4">
          ...
          <div className="relative z-10 -mt-[32px] px-[2px]">
            <HeroStage />
          </div>
        </div>
      </div>
